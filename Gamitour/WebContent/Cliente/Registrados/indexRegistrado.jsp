...
<body>
	...
	<div class="cabecera">
		<ul class="menu">
			<li style="background-color:black;"><a href="#"><i class="material-icons">home</i><span style="color:#f4d03f;">INICIO</span></a></li>
			...
			<li class="dropdown"><a href="/Gamitour/MostrarPublico.cl?id=usuario" class="dropbtn"><i class="material-icons">person</i><span>MI CUENTA</span></a>
